...
> Repository note: the SEMIKONG model code and assets now live under `model/` within the top-level repository. The future ontology and knowledge-graph assets will live under `ontology/`.
